...
<%@ include file="../../../Headers_&_Footers/Default/Solace/CSS_&_JS.jsp" %>   
								...
								<div class="row fluid-container mt--3">	
				                	...
				                	<div class="col-md-9">
										...
										<div class="row">						                		
											...
											<div class="col-md-10">
												<div class="form-group">		
													<textarea rows="1" class="form-control" id="Payload"></textarea>
										...
										<div class="row">						                		
											...
											<div class="col-md-10">
												<div class="form-group">		
													...
													<label id="Message_error" class="text-danger"></label>
												</div>
											</div>																	
										</div>
