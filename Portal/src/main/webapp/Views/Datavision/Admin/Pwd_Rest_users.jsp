...
<%@ include file="../../../Headers_&_Footers/Default/Administration/CSS_&_JS7.jsp" %> 
						...
						<div id="colour_body" class="card">
							...
							<div id="tab_card" class="card-body">
								...
								<div class="row mb-3">
									...
									<div class="col-md-4">
										<div class="form-group">
											<input type="text" id="tuserid" class="form-control">
								...
								<input type="hidden" id="tuseridd" value="<%= session.getAttribute("sesUserId") %>">
