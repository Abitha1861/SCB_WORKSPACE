...
<%@ include file="../../../Headers_&_Footers/Default/Administration/CSS_&_JS6.jsp" %>   
<% 
							...
							<div id="colour_body" class="card">
								...
								<div class="card-body">
									...
									<div class="row">	
										...
										<div class="col-md-4">
											<div class="form-group">		
												<input type="text" class="form-control" id="Accnm" placeholder="" maxlength="20" size="15">
												<label id="Accnm_error" class="text-danger"></label>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group">		
												<input type="text" class="form-control" id="AccOwnr" placeholder="" maxlength="20" size="15">											
									...
									<div class="row">	
										...
										<div class="col-md-4">
											<div class="form-group">		
												<select class="form-control" id="AccTy">
									...
									<div class="row">	
										...
										<div class="col-md-4">
											<div class="form-group">		
												<select class="form-control" id="rolecd">
												    <option value="">Select</option>
