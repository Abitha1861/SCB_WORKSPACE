<title>Forget Passord Reset</title>
	...
	<link href='<spring:url value="/resources/HDPAY/css/form_wizards/style.css" />' rel="stylesheet">
	...
	<script type="text/javascript" src='<spring:url value="/resources/HDPAY/ajax/libs/jquery/3.5.0/jquery.min.js"/>' ></script>
    ...
    <script type="text/javascript" src='<spring:url value="/resources/HDPAY/Validations/Login/Login.js" />' ></script> 
