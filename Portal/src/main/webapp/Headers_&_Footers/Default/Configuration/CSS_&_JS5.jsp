<title>${Menu.get('Title').getAsString()}</title>
	...
	<script type="text/javascript" src='<spring:url value="/resources/Default/js/plugin/xlsx.full.min.js"/>' ></script>
	...
	<script type="text/javascript" src='<spring:url value="/resources/Default/js/jquery.dataTables.print.min.js"/>' ></script>
	...
	<script type="text/javascript" src='<spring:url value="/resources/Default/Validations/Configuration/upload_excel.js" />' ></script> 
