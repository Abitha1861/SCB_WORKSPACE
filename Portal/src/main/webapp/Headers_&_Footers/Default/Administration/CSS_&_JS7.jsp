<title>${Menu.get('Title').getAsString()}</title>
	...
	<link href='<spring:url value="/resources/Default/css/progress_state.css" />' rel="stylesheet">
	...
	<script type="text/javascript" src='<spring:url value="/resources/Default/Validations/Login/Time_Out.js" />' ></script>	
 	<script type="text/javascript" src='<spring:url value="/resources/Default/Validations/Administration/Password_Reset_user.js" />' ></script>
