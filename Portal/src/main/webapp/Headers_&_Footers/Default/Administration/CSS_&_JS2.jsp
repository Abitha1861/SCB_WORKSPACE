<title>${Menu.get('Title').getAsString()}</title>
	...
	<link href='<spring:url value="/resources/Default/css/dataTables.bootstrap.min.css" />' rel="stylesheet">
	<link href='<spring:url value="/resources/Default/css/dataTables.responsive.min.css" />' rel="stylesheet">
	<link href='<spring:url value="/resources/Default/css/select.dataTables.min.css" />' rel="stylesheet">
	...
	<script type="text/javascript" src='<spring:url value="/resources/Default/Validations/Login/Time_Out.js" />' ></script>	
  	<script type="text/javascript" src='<spring:url value="/resources/Default/Validations/Administration/Admin_Approval.js" />' ></script> 
