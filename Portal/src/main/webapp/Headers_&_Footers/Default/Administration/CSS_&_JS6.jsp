<title>${Menu.get('Title').getAsString()}</title>
	...
	<script type="text/javascript" src='<spring:url value="/resources/Default/Validations/Administration/Account_Creation.js" />' ></script> 
	<script type="text/javascript" src='<spring:url value="/resources/Default/Validations/Administration/Sweet_alert.js" />' ></script>
