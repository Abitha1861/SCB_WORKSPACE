<title>${Menu.get('Title').getAsString()}</title>
	...
	<script type="text/javascript" src='<spring:url value="/resources/Default/js/core/moment.js"/>' ></script>
	<script type="text/javascript" src='<spring:url value="/resources/Default/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js"/>' ></script>
	<script type="text/javascript" src='<spring:url value="/resources/Default/js/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js"/>' ></script>	
	...
	<script type="text/javascript" src='<spring:url value="/resources/Default/js/jquery.dataTables.jszip.min.js"/>' ></script>
	<script type="text/javascript" src='<spring:url value="/resources/Default/js/jquery.dataTables.pdfmake.min.js"/>' ></script>
	<script type="text/javascript" src='<spring:url value="/resources/Default/js/jquery.dataTables.vfs_fonts.js"/>' ></script>
	...
	<script type="text/javascript" src='<spring:url value="/resources/Default/Validations/Reports/user_del.js" />' ></script> 
