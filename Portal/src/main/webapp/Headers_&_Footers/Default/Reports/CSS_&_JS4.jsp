<title>${Menu.get('Title').getAsString()}</title>
    ...
    <script type="text/javascript" src='<spring:url value="/resources/Default/Validations/Reports/Report_upload.js" />' ></script> 
    ...
    <script type="text/javascript" src='<spring:url value="/resources/Default/Validations/Reports/user_list_report.js" />' ></script>     
