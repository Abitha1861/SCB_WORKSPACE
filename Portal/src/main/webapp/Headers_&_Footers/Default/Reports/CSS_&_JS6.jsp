<title>${Menu.get('Title').getAsString()}</title>
	...
	<script type="text/javascript" src='<spring:url value="/resources/Default/js/autocomplete.js"/>' ></script>
    ...
    <script type="text/javascript" src='<spring:url value="/resources/Default/Validations/Reports/Security_report.js" />' ></script> 
