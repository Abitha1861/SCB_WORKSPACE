...
@Component
public class Webservice_Multicall_Modal 
{
	...
	private static final Logger logger = LogManager.getLogger(Webservice_Multicall_Modal.class);
	...
	public JsonObject Okhttp_Send_Rest_Request(JsonObject Api_details)
    {
    	...
    	try
    	{
    		...
    		if(!URLParameters.equals(""))
    		{
    			...
    			{
    				if(Params.size() !=0 && URL.contains("token"))
    				{
