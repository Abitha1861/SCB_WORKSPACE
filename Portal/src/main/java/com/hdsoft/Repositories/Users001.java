...
public class Users001 
{
	...
	public void setFIRST_PIN(String fIRST_PIN) {
		FIRST_PIN = fIRST_PIN;
	}
	public String getSECOND_PIN() {
		return SECOND_PIN;
	}
	public void setSECOND_PIN(String sECOND_PIN) {
	...
	public String getADMIN_HIER() {
		return ADMIN_HIER;
	}
	public void setADMIN_HIER(String aDMIN_HIER) {
		ADMIN_HIER = aDMIN_HIER;
	}
	...
	public void setREJECT_ON(String rEJECT_ON) {
		REJECT_ON = rEJECT_ON;
	}
	...
	public String getREJECT_REASON_DESCN() {
		return REJECT_REASON_DESCN;
	}
	public void setREJECT_REASON_DESCN(String rEJECT_REASON_DESCN) {
		REJECT_REASON_DESCN = rEJECT_REASON_DESCN;
	}
