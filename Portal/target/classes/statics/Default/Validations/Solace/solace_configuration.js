...
function Create_Event()
{
	...
	//details.addProperty("CorrelationID", 123);
    //details.addProperty("MessageID", 344);
	
	$.ajax({		 
		url  :  $("#ContextPath").val()+"/Solace/Topic/Publish/Message",
		type :  'POST',
		data :  data,
		cache : false,
		contentType : false,
		...
		{   
			...
			{
				var msg = 'CorrelationID : '+data.CorrelationID+'\n MessageID : '+data.MessageID;
				
				Sweetalert("success", msg, data.Message);
			}
			else
		    {
